...
% ------------------------
\path (sched6e0) ++ (6,0) coordinate(sched6e4);
\path (sched5e0) ++ (6,0) coordinate(sched5e4);
\path (sched4e0) ++ (1,0) coordinate(sched4e1) ++ (5,0) coordinate(sched4e4);
\path (sched3e0) ++ (6,0) coordinate(sched3e4);
\path (sched2e0) ++ (4,0) coordinate(sched2e2) ++ (2,0) coordinate(sched2e4);
\path (sched1e0) ++ (5,0) coordinate(sched1e3) ++ (1,0) coordinate(sched1e4);
