...
Sketch Creation: Wed Sep 14 13:45:24 2016
...
\node (D1) [task_style] {$D1$};
\node (T1) [task_style, right=of D1] {$T1$};
\node (T2) [task_style, right=of T1] {$T2$};
\node (T4) [task_style, right=of T2] {$T4$};
\node (sched1) [sched_style, below=of D1] {$sched1$};

\node (PE0) [pe_style, below=of sched1] {$PE0$};


\draw (T1) [fifo_buffer_style] to[out=30,in=150] (T2);
\draw (D1) [fifo_buffer_style] to[out=30,in=150] (T1);
\draw (D1.south) [task_map_arrow] -- (sched1.north);
