...
Sketch Creation: Thu Jul 21 11:14:01 2016
...
\draw (T1) [fifo_buffer_style, postaction={decorate,decoration={text along path,text align=center,text={$fifo2{\;}$}}}] to[out=30,in=145] (T2);
...
\draw (T4) [fifo_buffer_style, postaction={decorate,decoration={text along path,text align=center,text={$E3{\;}$}}}] to[out=30,in=145] (T5);
\draw (T4) [fifo_buffer_style, postaction={decorate,decoration={text along path,text align=center,text={$E4{\;}$}}}] to[out=35,in=145] (T6);
...
\draw (T8) [fifo_buffer_style, postaction={decorate,decoration={text along path,text align=center,text={$E19{\;}$}}}] to[out=590483261,in=280] (T10);
\draw (D4_IN) [fifo_buffer_style, postaction={decorate,decoration={text along path,text align=center,text={$fifo10{\;}$}}}] to[out=30,in=140] (T7);
...
\draw (BE1.south) [task_map_arrow] -- (sched1.north);
