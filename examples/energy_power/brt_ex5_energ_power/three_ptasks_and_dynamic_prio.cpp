...
//   scheduler1.set_dynamic_dispatch_policy(EARLY_DEADLINE_FIRST);
   ...
   // time performance related reports
   ...
   cout << "task \"" << task_info_t1.name() << "\": consumed_energy =" << task_info_t1.get_consumed_energy_J() << " J " << endl;
   cout << "task \"" << task_info_t2.name() << "\": consumed_energy =" << task_info_t2.get_consumed_energy_J() << " J " << endl;
   cout << "task \"" << task_info_t3.name() << "\": consumed_energy =" << task_info_t3.get_consumed_energy_J() << " J " << endl;   
   cout << "*********************************************" << endl;
