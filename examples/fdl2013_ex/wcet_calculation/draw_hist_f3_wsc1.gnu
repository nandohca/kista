...
plot for [COL=2:3] 'times_f3_sc1_scaled.dat' using COL:xticlabels(1) axes x1y1
#plot 'times_f3_sc1_scaled.dat' using 2:xticlabels(1) ti col fc rgb "#FF0000", '' using 3 ti col fc rgb MyBlue  axes x1y1
#plot for [COL=2:3] 'times_f3_sc1_scaled.dat' using COL:xticlabels(1) ti col fc rgb "#FF0000", '' using 3 ti col fc rgb MyBlue axes x1y1
