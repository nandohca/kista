...
\node (T1) [task_style, below=of T10] {$T1$};
...
\node (rtos1) [sched_style, below=of T1] {$rtos1$};
\node (sched2) [sched_style, right=of rtos1] {$sched2$};
...
\node (PE1) [pe_style, below=of rtos1] {$PE1$};
...
\draw (T1.south) [task_map_arrow] -- (rtos1.north);
\draw (T2.south) [task_map_arrow] -- (rtos1.north);
...
\draw (rtos1.south) [sched_map_arrow] -- (PE1.north);
...
\begin{scope}[on background layer]
\node[sys_box_st,fit = (T1)(T2)(T3)(T4)(T5)(T6)(T7)(T8)(rtos1)(sched2)(sched3)(sched4)(sched5)(sched6)(PE1)(PE2)(PE3)(PE4)(PE5)(PE6)(tdma1)] (sys_box) {};
\end{scope}
